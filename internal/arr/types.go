...
type Artist struct {
	...
	Monitored  bool        `json:"monitored"`
	Statistics ArtistStats `json:"statistics"`
}

// ArtistStats holds album/track statistics for an artist.
...
type Author struct {
	...
	Monitored  bool        `json:"monitored"`
	Statistics AuthorStats `json:"statistics"`
}

// AuthorStats holds book statistics for an author.
