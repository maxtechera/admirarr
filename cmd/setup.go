...
func init() {
	...
	setupCmd.Flags().BoolVar(&setupDryRunFlag, "dry-run", false, "Preview changes without applying")
...
func runSetup(cmd *cobra.Command, args []string) {
	...
	if setupAutoFlag {
		setup.RunAuto(setupDryRunFlag)
	} else {
		setup.Run(setupDryRunFlag)
	}
}
